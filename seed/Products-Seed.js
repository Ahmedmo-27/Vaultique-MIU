...

{
...

  {
    ...
    stock:'true',
    stockCount: '5',
    Vcollection: 'luxury and heritage',
    gender: 'Male',
    price: '$180,000.00',
...

  {
    ...
    gender: 'Male',
    price: '$120,000.00',
    image: '/Assets/Images/Photos/A lange/a-lange-sohne-zeitwerk-striking-time-white-gold-black-dial-145-029-a-lange-sohne-40258736947444.jpg',
    galleryImages: [
...

  {
    ...
    description: "The Octo Retrogradi combines Bvlgari's signature octagonal design with retrograde displays and chronograph functionality.",
    specifications: [
      {
        specName: 'Case Diameter',
        specValue: '45 mm',
      ...
      {
        specName: 'Functions',
        specValue: 'Hours, Minutes, Retrograde Date, Retrograde Day, Chronograph',
      },
      {
        specName: 'Caliber',
        specValue: 'BVL 318',
    ...
    specialFeatures: [
      {
        featureName: 'Retrograde Displays',
        featureDesc: 'For date and day indications',
      },
      {
      ...
      {
        featureName: 'Octagonal Case',
        featureDesc: 'Signature Bvlgari design',
      },
      {
        featureName: 'Transparent Caseback',
        featureDesc: 'View of the decorated movement',
      },
      {
        featureName: 'Guilloché Dial',
        featureDesc: 'Hand-finished decorative pattern',
      },
      {
        featureName: 'Rose Gold Case',
        featureDesc: 'Luxurious 18k rose gold construction',
      },
    ],
  },
